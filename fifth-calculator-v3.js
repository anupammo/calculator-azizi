function stepOne() {
    ...
    tblf.rows[2].cells[3].innerHTML = "RM" + (vfs1 + vfs2 + vfs3 + vfs4 + vfs5 + vfs6 + vfs7 + vfs8 + vfs9 + vfs10 + vfs11 + vfs12).toFixed(2);
    ...
    tblf.rows[3].cells[3].innerHTML = "RM" + ((tgain1 + tgain2 + tgain3 + tgain4 + tgain5 + tgain6 + tgain7 + tgain8 + tgain9 + tgain10 + tgain11 + tgain12).toFixed(2)-(vfs1 + vfs2 + vfs3 + vfs4 + vfs5 + vfs6 + vfs7 + vfs8 + vfs9 + vfs10 + vfs11 + vfs12).toFixed(2));
